...
description: "How system instructions work, where to set them, limits, and how they interact with memory/knowledge/training."
---
...
- `systemInstructions`: up to `8000` characters
